...
<div class="login-box">
        <?php if(isset($_REQUEST['msg']) == 'error' || isset($_REQUEST['msg']) == 'r_success' || isset($_REQUEST['msg']) == 'product'){?>
                <?php if($_REQUEST['msg'] == 'error'){?>
                        <div class="alert alert-danger alert-dismissable text-center">
                            ...
                            <p>Provided email address & mobile number is not registered into our system please check your entered deatils</p>
                        </div>
                <?php } else if ($_REQUEST['msg'] == 'r_success') {?>
                        <div class="alert alert-success alert-dismissable text-center">
                            <h4><i class="icon fa fa-check"></i> Success!</h4>
                            <p>Password updated successfully please check email for credentials </p>
                        </div>
    ...
    <div class="login-box-body">
        ...
        <form action="forget_password_save.php" method="post">
            ...
            <div class="col-xs-12 ">
                    <div class="form-group">
                        <a href="login.php" class="btn btn-primary  btn-flat">log-in</a>
                        <button type="submit" class="btn btn-primary  btn-flat pull-right">Submit <i class="fa fa-plus-square-o"></i></button>
                    </div>
                </div>
